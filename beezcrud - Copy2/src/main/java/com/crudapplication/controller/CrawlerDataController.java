...
public class CrawlerDataController {
    ...
    */
    ...
    //@RequestParam(defaultValue = "id") String sortBy)
    {
        ...
        //Page<CrawlerData> page = CrawlerDataPagingRepository.findAll(predicate, pageable); // This line has issues
    ...
    */
    ...
    public CrawlerDataController(CrawlerDataPagingRepository crawlerDataPagingRepository) {
    }
}
